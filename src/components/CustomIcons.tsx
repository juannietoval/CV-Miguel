...
export const AcademiaIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg 
    role="img" 
    viewBox="0 0 24 24" 
    width={size} 
...
export const GoogleScholarIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg 
    role="img" 
    viewBox="0 0 24 24" 
    width={size} 
...
export const ResearchGateIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
  <svg 
    role="img" 
    viewBox="0 0 24 24" 
    width={size} 
