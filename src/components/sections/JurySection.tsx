import { Gavel, ChevronDown, ChevronUp, ExternalLink } from 'lucide-react';
...
export default function JurySection() {
  return (
    <section id="jury" className={`scroll-mt-20 md:scroll-mt-28 transition-all duration-500 expanded`}>
